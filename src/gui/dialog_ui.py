...
from gui.prediction_ui import Ui_Prediction
...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog, index, BGMs):
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(880, 650, 93, 28))
    ...
    def retranslateUi(self, Dialog, index, BGMs):
        ...
        png = QPixmap("./gui//output_data/fig" + str(index) + ".png")
        ...
        self.pushButton_3.setText(_translate("Dialog", "热度预测"))
        self.pushButton_3.clicked.connect(lambda: self.predict(index))

    def play(self):
        music_path = "./gui/input_data/" + self.BGM[0] + ".mp3"
    ...
    def predict(self, index):
        prediction = QDialog()
        prediction_ui = Ui_Prediction()
        prediction_ui.setupUi(prediction, index)
        prediction.exec_()
